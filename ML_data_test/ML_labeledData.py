...
def ML_test(data_path):
    ...
    accuracy = ML_Accuracy.ML_accuracy(data_path, "ML_output.dat")
...
if __name__ == "__main__":
    ...
    data_path = "/Users/rhuck/Downloads/DL_Phylo/Recombination/test_data/test1_fact5_sl10000_dev.npy"
    accuracy, incorrect, total = ML_test(data_path)
